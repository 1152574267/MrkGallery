...
public class LabelDetectFragment extends Fragment implements
        MRecyclerViewAdapter.OnItemClickListener, MRecyclerViewAdapter.OnItemLongClickListener {
    private static final String TAG = LabelDetectFragment.class.getSimpleName();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new MRecyclerViewAdapter<PhotoItem>(mContext, photoList, DbHelper.MODULE_LABEL_DETECT);
