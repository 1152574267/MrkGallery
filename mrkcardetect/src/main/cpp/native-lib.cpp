...
Java_com_mrk_mrkcardetect_CarNumDetectActivity_init(JNIEnv *env, jobject instance, jstring svm_,
...
JNIEXPORT void JNICALL
Java_com_mrk_mrkcardetect_CarNumDetectActivity_release(JNIEnv *env, jobject instance) {
    if (carPlateRecgize)
        delete carPlateRecgize;
}

JNIEXPORT jstring JNICALL
Java_com_mrk_mrkcardetect_CarNumDetectActivity_recognition(JNIEnv *env, jobject instance,
