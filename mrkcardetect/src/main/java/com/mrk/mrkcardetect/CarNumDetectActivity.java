...
public class CarNumDetectActivity extends AppCompatActivity {
...
//            训练ann字符识别模型耗时: 63.18750 ,保存: HOG_ANN_DATA.xml
    ...
    private void requestPermissions() {
        RxPermissions rxPermission = new RxPermissions(CarNumDetectActivity.this);
        //请求权限全部结果
        rxPermission.request(
                ...
                .subscribe(new Consumer<Boolean>() {
                    ...
                    public void accept(Boolean granted) {
                        if (!granted) {
                            Toast.makeText(CarNumDetectActivity.this, "未能获取全部需要的相关权限", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
